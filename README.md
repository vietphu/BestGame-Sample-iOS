...
Secret** above.  When you move to production you will need new a new
...
you may need to keep the latest score in memory and pass this around. To
facilitate this you can use a small singleton class that contains the
...
Push notifications allow your app to be notified when a player has been
challenged or a new tournament has been made available. This feature
will be available in the released version of the Propeller SDK 2.0. For
further information please contact Grantoo developer support.

### Preparations

1. You must submit to Grantoo a push SSL certificate that you obtain
...
1. Generate a new provisioning profile containing the push entitlement.
...
1. Register for push notifications in your AppDelegate.
...
1. Handle push notification when the app is inactive.
...
1.  Handle push notification when the app is active.
